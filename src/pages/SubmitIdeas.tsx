...
export const SubmitIdeas = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.email || !formData.ideaTitle || !formData.ideaDescription) {
      toast({
    ...
    try {
      ...
      toast({
        ...
        description: "Thank you for your innovative contribution to Anvitha ECE Club",
      });
        ...
        >
          <div className="holo-card p-12 max-w-2xl mx-auto">
            ...
            <p className="text-glow-green/80 font-exo text-lg mb-8">
              Your innovative idea has been successfully submitted to Anvitha ECE Club. 
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-center text-glow-green/70">
                ...
                <span className="font-exo">Idea sent to club administrators</span>
              </div>
              <div className="flex items-center text-glow-green/70">
                <CheckCircle className="w-5 h-5 text-cyber-green mr-3" />
                <span className="font-exo">Confirmation email sent to your inbox</span>
              </div>
              <div className="flex items-center text-glow-green/70">
                <CheckCircle className="w-5 h-5 text-cyber-green mr-3" />
                <span className="font-exo">You'll receive updates on implementation status</span>
              </div>
            </div>
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        >
          ...
          <p className="text-xl text-glow-green/80 font-exo max-w-3xl mx-auto">
            Share your innovative ECE project ideas with us. From IoT solutions to circuit innovations, 
            your creativity drives our club's technological advancement.
          </p>
        </motion.div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  {categories.map(category => (
                    <option key={category} value={category} className="bg-dark-panel">
                      {category}
                    </option>
                  ))}
                </select>
              ...
              <div>
                ...
                <div className="mt-2 text-sm text-glow-green/60 font-exo">
                  Minimum 100 characters. Current: {formData.ideaDescription.length}
                </div>
              </div>
            </div>
            ...
            <div className="holo-card p-6 bg-cyber-green/5">
              ...
              <ul className="space-y-2 text-glow-green/70 font-exo text-sm">
                <li className="flex items-start">
                  ...
                  Ideas should be related to Electronics & Communication Engineering
                </li>
                <li className="flex items-start">
                  <Zap className="w-4 h-4 mr-2 mt-0.5 text-cyber-green flex-shrink-0" />
                ...
                <li className="flex items-start">
                  <Zap className="w-4 h-4 mr-2 mt-0.5 text-cyber-green flex-shrink-0" />
                  Innovative solutions addressing real-world problems are preferred
                </li>
                <li className="flex items-start">
                  <Zap className="w-4 h-4 mr-2 mt-0.5 text-cyber-green flex-shrink-0" />
            ...
            <div className="grid md:grid-cols-3 gap-6 text-sm">
              <div className="text-center">
                <div className="w-8 h-8 bg-cyber-green/20 rounded-full flex items-center justify-center mx-auto mb-2">
                  <span className="font-orbitron font-bold text-cyber-green">1</span>
                </div>
              ...
              <div className="text-center">
                <div className="w-8 h-8 bg-cyber-green/20 rounded-full flex items-center justify-center mx-auto mb-2">
                  <span className="font-orbitron font-bold text-cyber-green">2</span>
                </div>
                <p className="text-glow-green/70 font-exo">
              ...
              <div className="text-center">
                <div className="w-8 h-8 bg-cyber-green/20 rounded-full flex items-center justify-center mx-auto mb-2">
                  <span className="font-orbitron font-bold text-cyber-green">3</span>
                </div>
                <p className="text-glow-green/70 font-exo">
