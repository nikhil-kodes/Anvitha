	...
	return {
		Technical: {
			...
			positionHolders: [
				{
					...
					socials: "https://www.linkedin.com/in/abhinav-aggarwal-56b1b9286/",
					year: "3rd",
					image: abhinav,
					post: "Director",
				},
				{
					name: "Ravi Shankar",
					socials: "https://www.linkedin.com/in/ravi-shankar-gupta-ab19bb259",
					year: "3rd",
					image: ravi,
					post: "Co-director",
				},
			...
			executiveMembers: [
				{
					name: "Nikhil Singh",
					socials: "https://www.linkedin.com/in/nikhil-singh-2785a32a2",
					year: "2nd",
				},
			],
			members: [
		...
		Management: {
			...
			members: [
				...
				{ name: "Suman Kumar", socials: "", year: "2nd" },
				{ name: "Harshit Singh", socials: "", year: "2nd" },
				{
					name: "Akshit Mishra",
					socials:
						"https://www.linkedin.com/in/akshit-kumar-mishra?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3B1qVyRVKZSYWhwhq8zXda2g%3D%3D",
					year: "2nd",
				},
				{ name: "Saumya Goyal", socials: "", year: "2nd" },
				{ name: "Priyanshu", socials: "", year: "2nd" },
			],
		},
		...
		DAM: {
			...
			positionHolders: [
				...
				{
					name: "Vartika Singh",
					socials: "https://www.linkedin.com/in/vartika-singh-40126a314",
					year: "3rd",
					image: vartika,
					post: "Co-director",
				},
			],
			executiveMembers: [{ name: "Pritam Raj", socials: "", year: "3rd" }],
			members: [
				{
					name: "Sudheer",
					socials: "https://www.linkedin.com/in/sudheerkumar427",
					year: "2nd",
				},
				{
		...
		Photography: {
			...
			positionHolders: [
				...
				{
					name: "Sanjay Yadav",
					socials: "https://www.linkedin.com/in/sanjay-yadav-851834348",
					year: "2nd",
					image: sanjay,
					post: "Co-director",
				},
			],
			executiveMembers: [{ name: "Abhishek", socials: "", year: "3rd" }],
			members: [
				{
					name: "Akshay Mishra",
					socials: "https://www.linkedin.com/in/akshay-mishra-28448b32a",
					year: "2nd",
				},
