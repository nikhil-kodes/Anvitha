...
const hallOfFameMembers = [
  {
    ...
    year: "2015-2017",
    achievements: ["Established club foundation", "First robotics team", "IEEE collaboration"],
  ...
  },
  {
    ...
    role: "President",
    year: "2018-2019", 
    achievements: ["National competition winner", "IoT workshop series", "Industry partnerships"],
  ...
  },
  {
    ...
    role: "President",
    year: "2019-2020",
    achievements: ["Virtual event innovation", "Coding bootcamps", "Alumni network expansion"],
    legacy: "Transformed club operations during challenging times with innovation",
  },
  {
    name: "Arpit Sharma",
    role: "Technical Director", 
    year: "2020-2021",
    achievements: ["PCB design workshops", "Circuit simulation lab", "Patent filing guidance"],
  ...
  },
  {
    ...
    role: "President",
    year: "2021-2022",
    achievements: ["Smart city project", "Women in tech initiatives", "International collaborations"],
  ...
  },
  {
    ...
    role: "Vice President",
    year: "2022-2023", 
    achievements: ["AI/ML study groups", "Startup incubation", "Publication mentorship"],
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="text-xl text-glow-green/80 font-exo max-w-3xl mx-auto">
            Honoring the legendary leaders who shaped Anvitha ECE Club's legacy of excellence and innovation
          </p>
        </motion.div>
              ...
              >
                ...
                <div className="w-5/12 relative">
                  <motion.div
                    ...
                    style={{
                      background: 'linear-gradient(145deg, hsl(var(--dark-panel)), hsl(var(--space-black)))',
                    }}
                  >
                    ...
                    <div className="mb-4">
                      ...
                      <ul className="space-y-1">
                        {member.achievements.map((achievement, i) => (
                          <li key={i} className="text-glow-green/70 font-exo text-sm flex items-start">
        ...
        >
          <div className="holo-card p-8 max-w-4xl mx-auto">
            ...
            <p className="text-glow-green/80 font-exo leading-relaxed">
              These visionary leaders have left an indelible mark on Anvitha ECE Club. 
              Their dedication, innovation, and leadership continue to inspire current and future generations. 
              Their legacy lives on in every project, every achievement, and every moment of excellence 
