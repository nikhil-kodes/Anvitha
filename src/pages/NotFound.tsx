        ...
        <div className="holo-card p-12">
          ...
          >
            ...
            <p className="text-glow-green/80 font-exo text-lg leading-relaxed">
              The path <code className="bg-dark-panel px-2 py-1 rounded text-cyber-green">
                {location.pathname}
              </code> doesn't exist in our system. 
              The connection has been lost in the digital void.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <Link to="/" className="btn-cyber group inline-flex items-center">
